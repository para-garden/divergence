...
- [x] What does software look like in divergence? — open, writable, yours. no locked ecosystems, no platform ownership. it doesn't have a special name because it doesn't need one. (lumen is legacy's word for this — in divergence the thing exists but the word doesn't, because here it's unremarkable.)
...
- [ ] **Bakery node** — currently clean authorial prose from nowhere. needs a narrator. is it Marta's own page? a neighbor's note? the register changes entirely depending on who wrote it.
- [ ] **Building node** — same problem. plus needs a real name (see place naming below).
- [ ] **Place naming** — "the building" is a placeholder. figure out what this specific building is called by the people who live near it. the naming convention is descriptive-not-commemorative (in CLAUDE.md) but we haven't applied it yet.
- [ ] **What city is this?** — location affects dialect, specificity, everything. undecided.

## Voice / language directions

- Every node needs a narrator — who in this world wrote or made it. the narrator determines the register.
- Documents from different people should sound different. not a unified web voice. shared infrastructure, not shared register.
- Platform English doesn't exist here. writing wasn't optimized into skimmability. pages sound like whoever made them.
- American English still exists and is still relatively flat (broadcast TV did that already). regional dialects are more alive than they are now. the metalhead and the imagine dragons fan both have pages, neither sounds like the other.

## Voice touchstones

- **"adulting"** — in divergence this word has no referent. becoming an adult means you have more say in where you are and what you do. someone explaining the concept of "adulting" would sound like they were describing a grimdark premise — a world where becoming an adult means navigating systems designed to be hostile, where a wrong insurance decision could ruin you. in divergence: you just became an adult. you got a flat. the light was good.
